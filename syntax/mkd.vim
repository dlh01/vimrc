...
" commenting next line because it interferes with normal bracket use
" syn region mkdLink matchgroup=mkdDelimiter      start="\!\?\[" end="\]\ze\s*[[(]" contains=@Spell nextgroup=mkdURL,mkdID skipwhite
" replacing it with this one (note the change in 'end')
syn region mkdLink matchgroup=mkdDelimiter      start="\!\?\[" end="\]" contains=@Spell nextgroup=mkdURL,mkdID skipwhite
...
" comment out so that footnote text doesn't get odd color
